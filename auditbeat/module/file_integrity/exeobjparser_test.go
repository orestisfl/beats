...
var want = map[string]mapstr.M{
	"go_pe": {
		"pe": mapstr.M{
			...
			"go_imports": []string{
				"github.com/elastic/beats/v8/auditbeat/module/file_integrity/testdata/b.Used",
				"github.com/elastic/beats/v8/auditbeat/module/file_integrity/testdata/b.hash",
			},
		},
	},
	"go_elf": {
