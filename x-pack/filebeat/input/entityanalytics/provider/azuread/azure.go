...
import (
	...
	"github.com/elastic/beats/v8/x-pack/filebeat/input/entityanalytics/provider"
	"github.com/elastic/beats/v8/x-pack/filebeat/input/entityanalytics/provider/azuread/authenticator"
	"github.com/elastic/beats/v8/x-pack/filebeat/input/entityanalytics/provider/azuread/authenticator/oauth2"
	"github.com/elastic/beats/v8/x-pack/filebeat/input/entityanalytics/provider/azuread/fetcher"
	"github.com/elastic/beats/v8/x-pack/filebeat/input/entityanalytics/provider/azuread/fetcher/graph"
