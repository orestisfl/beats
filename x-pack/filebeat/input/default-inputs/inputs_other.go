...
import (
	...
	"github.com/elastic/beats/v8/x-pack/filebeat/input/azureblobstorage"
	"github.com/elastic/beats/v8/x-pack/filebeat/input/cel"
	"github.com/elastic/beats/v8/x-pack/filebeat/input/cloudfoundry"
	"github.com/elastic/beats/v8/x-pack/filebeat/input/entityanalytics"
	"github.com/elastic/beats/v8/x-pack/filebeat/input/gcs"
	...
	"github.com/elastic/beats/v8/x-pack/filebeat/input/lumberjack"
	"github.com/elastic/beats/v8/x-pack/filebeat/input/o365audit"
	"github.com/elastic/beats/v8/x-pack/filebeat/input/shipper"
