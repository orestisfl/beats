...
require (
	...
	github.com/elastic/cloudbeat v0.0.0-20250904124111-9bd0d6c3559e
...
replace (
	...
	github.com/elastic/cloudbeat => github.com/orestisfl/cloudbeat v0.0.0-20250905105327-a0dbe69bdf72
